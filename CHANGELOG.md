...
#### Library
- 285 types auto-generated from Telegram Bot API 9.4 (257 structs, 21 union/enum types, 7 marker types)
...
- `Poller` - async long-polling dispatcher
...
#### GitHub Actions
- `auto-regenerate.yml` - spec check, codegen, auto-PR with diff report
- `ci.yml` - build/test/lint on Ubuntu, Windows, macOS x stable/beta Rust
...
- `build_pr_body.py` - PR description generator
- `coverage_report.py` - Markdown coverage table
- `update_changelog.py` - auto CHANGELOG updater

---

*Future versions are added automatically as Telegram releases new Bot API versions.*
